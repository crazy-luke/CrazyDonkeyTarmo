...
# 
# # Object Detector
OBJECT_DETECTOR = True  # enable Detector lab; 
...
OD_ACTION_DEMO = True              # enable detection to trigger a demo action
OD_ACTION_DEMO_LABEL = "person"     # label to trigger demo action

OD_ACTION_STOP_AND_GO = True           # enable detection to stop and go
